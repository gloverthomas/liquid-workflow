 ...
 *
 *   npm run trigger              # LIQ-24 AI Assistant (default hero)
 *   npm run trigger -- --liq17
 *   npm run trigger -- --liq16
...
const useLiq16 = process.argv.includes("--liq16");
const useLiq17 = process.argv.includes("--liq17");
